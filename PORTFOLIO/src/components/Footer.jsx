      ...
      <div className="footer-actions">
        ...
        >
          <span className="button-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" stroke="currentColor" strokeWidth="0.6" strokeLinejoin="round" strokeLinecap="round" xmlns="http://www.w3.org/2000/svg">
          ...
          <span aria-hidden="false">Escribime</span>
        </a>
        <a
